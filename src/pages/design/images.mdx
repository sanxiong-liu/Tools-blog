...
<div class="flex gap-4">
  <Icon name="fish" class="h-24 w-24 text-primary" />
  <Icon name="github" class="h-24 w-24 text-secondary" />
  <Icon name="rabbit-variant-outline" class="h-24 w-24 text-accent" />
</div>
